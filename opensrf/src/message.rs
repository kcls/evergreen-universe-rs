...
impl TransportMessage {
    ...
    pub fn to_json_value(&self) -> json::Value {
        ...
        let mut obj = json::json!({
            "to": json::from_str(self.to()),
            "from": json::from_str(self.from()),
            "thread": json::from_str(self.thread()),
            "osrf_xid": json::from_str(self.osrf_xid()),
            "body": body,
        });

        if let Some(rc) = self.router_command() {
            obj["router_command"] = json::from_str(rc);
        }

        if let Some(rc) = self.router_class() {
            obj["router_class"] = json::from_str(rc);
        }

        if let Some(rc) = self.router_reply() {
            obj["router_reply"] = json::from_str(rc);
        }
...
impl Message {
    ...
    pub fn to_json_value(&self) -> json::Value {
        ...
        let mut obj = json::json!({
            "threadTrace": json::from_str(self.thread_trace),
            "type": json::from_str(mtype),
            "locale": json::from_str(self.locale()),
            "timezone": json::from_str(self.timezone()),
            "api_level": json::from_str(self.api_level()),
            "ingress": json::from_str(self.ingress()),
        });
...
impl Result {
    ...
    pub fn to_json_value(&self) -> json::Value {
        let obj = json::json!({
            "status": json::from_str(self.status_label()),
            "statusCode": json::from_str(self.status as isize),
...
impl Method {
    ...
    pub fn to_json_value(&self) -> json::Value {
        let obj = json::json!({
            "method": json::from_str(self.method()),
            "params": json::from_str(self.params().to_vec()),
        });
