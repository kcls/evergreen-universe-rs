...
impl Session {
    ...
    ///
    /// If the msg17_stamp_transit is enabled and an org unit id value is
    /// configured at msg17_stamp_transit_org_unit (for this session),
    /// update the transit source to the provided org unit and update the
    /// send time to now.
    ///
