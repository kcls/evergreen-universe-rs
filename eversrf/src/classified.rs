...
impl ClassifiedJson {
    ...
    /// let obj = eversrf::classified::ClassifiedJson::classify(obj, "abc");
    ...
    /// Returns the classname if the provided JsonValue is shaped
    /// like a classed object.
    pub fn classname(obj: &json::JsonValue) -> Option<&str> {
        if obj.is_object()
    ...
    /// ```
    /// // shorthand
    /// type Dec = eversrf::classified::ClassifiedJson;
    ///
    ...
    /// let value_op = eversrf::classified::ClassifiedJson::declassify(obj);
