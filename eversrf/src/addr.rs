...
impl BusAddress {
    ...
    /// ```
    /// let addr =
    ///   eversrf::addr::BusAddress::from_str("opensrf:client:foobar:localhost:12345")
    ...
    ///
    /// ```
    /// let addr = eversrf::addr::BusAddress::for_router("router", "private.localhost");
    ///
    ...
    ///
    /// ```
    /// let addr = eversrf::addr::BusAddress::for_bare_service("opensrf.settings");
    ///
    ...
    /// let addr = eversrf::addr::BusAddress::for_client(username, domain);
    ...
    /// let username = "opensrf";
    /// let domain = "private.localhost";
    /// let mut addr = eversrf::addr::BusAddress::for_client(username, domain);
    /// assert_eq!(addr.domain(), domain);
    ///
